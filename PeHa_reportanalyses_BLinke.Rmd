...
names(peha.c) <- c("Date","Precip","Tmin","tmean","Tmax","vpdmin","vpdmax","Site","Year","Month")
...
peha_FlYN <- merge(peha, peha_c, by.x = c("Site","Year"), by.y =c("Site","Prev12") )
peha_FlYN <- merge(peha_FlYN, peha_vapordeficit, by.x = c("Site","Year"), by.y =c("Site","Prev12"))
