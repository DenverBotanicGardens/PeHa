...
lm1 <- glm(Fl ~ Site*Tmin, family = binomial(link = "logit"), peha_FlYN)  #   #2
lm2 <- glm(Fl ~ Site*Tmax, family = binomial(link = "logit"),peha_FlYN) #     #3
lm3 <- glm(Fl ~ Site*vpdmax, family = binomial(link = "logit"),peha_FlYN) # how much vapor deficit
lm4 <- glm(Fl ~ Site*x, family = binomial(link = "logit"),peha_FlYN) # x is precipitation
lm5 <- glm(Fl ~ Tmin, family = binomial(link = "logit"),peha_FlYN)
lm6 <- glm(Fl ~ Tmax, family = binomial(link = "logit"),peha_FlYN) 
lm7 <- glm(Fl ~ x, family = binomial(link = "logit"),peha_FlYN) #             #1
lm8 <- glm(Fl ~ vpdmax, family = binomial(link = "logit"),peha_FlYN)
