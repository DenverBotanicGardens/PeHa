...
ggsave(paste(userpath,currentyr,"_Penstemon-harringtonii_Fig2.jpg", sep=""),
       ...
       Fig2a + Fig2b + Fig2c + Fig2d + fig2e_vpdmax + fig2f_tmin + fig2d_tmax + plot_layout(ncol = 2),
...
lm1 <- glm(Fl ~ Site*Tmin, family = binomial(link = "logit"), peha_all)
lm2 <- glm(Fl ~ Site*Tmax, family = binomial(link = "logit"),peha_all)
...
lm7 <- glm(Fl ~ x, family = binomial(link = "logit"),peha_all)
