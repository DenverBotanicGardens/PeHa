...
Fig4a_2 <- ggplot(peha_all, aes(vpdmax, TotRos, colour = Site)) +
  ...
  xlab("") +
  ylab(expression(paste("Average rosettes per 60m"^2))) +
  xlab("Maximum water vapor deficit")+
  theme(legend.justification=c(0,1), legend.position=c(0,1),
        legend.background = element_rect(fill=alpha('white', 0.1)))+
  ggtitle("a)") +
  theme(plot.title=element_text(hjust=0))
...
```{r}
jpeg(paste("Q:/Research/All_Projects_by_Species/Penstemon SPECIES/Penstemon_harringtonii/Reports/Word ",currentyr, "_PeHa/Fig4.jpg", sep=""), width=250, height=500, units="mm", res=300)
