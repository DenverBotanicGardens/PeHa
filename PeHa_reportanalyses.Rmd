...
```{r}
ggplot(peha_all, aes(x, TotRos, colour = Site)) +
  geom_point() +
...
```{r}
ggplot(peha_all, aes(x, Fl, colour = Site)) +
  geom_point() +
  geom_smooth(method ="lm") +
  scale_color_manual(values = c("black","red")) +
  theme_bw() +
...
```{r}
ggplot(peha_all, aes(x, Br, colour = Site)) +
  geom_point() +
  geom_smooth(method ="lm") +
  scale_color_manual(values = c("black","red")) +
  theme_bw() +
...
```{r}
summary(lm(log(TotRos+1)~Precip*Site,data = peha_all))

# Dry Lake only
summary(lm(log(TotRos+1)~Precip,data = subset(peha_all, Site == "Dry Lake")))


# Above Eagle only
summary(lm(log(TotRos+1)~Precip,data = subset(peha_all, Site == "Above Eagle")))
```

ANOVA and lm of percent reproductive and precipitation
```{r}
summary(lm(asin(sqrt(Fl))~Precip*Site,data = peha_all))

# Dry Lake only
summary(lm(asin(sqrt(Fl))~Precip,data = subset(peha_all, Site == "Dry Lake")))


# Above Eagle only
summary(lm(asin(sqrt(Fl))~Precip,data = subset(peha_all, Site == "Above Eagle")))
```


ANOVA and lm of percent browsing and precipitation
```{r}
summary(lm(asin(sqrt(Br))~Precip*Site,data = peha_all))

# Dry Lake only
summary(lm(asin(sqrt(Br))~Precip,data = subset(peha_all, Site == "Dry Lake")))


# Above Eagle only
summary(lm(asin(sqrt(Br))~Precip,data = subset(peha_all, Site == "Above Eagle")))
```
